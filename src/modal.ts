...
export class PromptModal extends Modal {
	...
	build_image_modal() {
		...
		let options = ["1024x1024", "512x512", "256x256"];
		this.param_dict["img_size"] = options[0];
...
export class ChatModal extends Modal {
	...
	constructor(app: App, assistant: OpenAIAssistant | AnthropicAssistant) {
		super(app);
...
export class SpeechModal extends Modal {
	...
	assistant: OpenAIAssistant | AnthropicAssistant;
	editor: Editor;
